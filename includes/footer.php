            ...
            <div class="block-group has-global-padding is-layout-constrained block-group-is-layout-constrained">
                ...
                aria-label="Réseaux Sociaux">
                    <ul class="block-navigation__container has-medium-font-size items-justified-center no-wrap filter-invert block-navigation has-medium-font-size">
                        ...
                        <li class="has-medium-font-size block-navigation-item block-navigation-link"><a class="block-navigation-item__content" href="https://www.youtube.com/@CARIBOND" title="Nos incroyables productions audiovisuelles"><span class="block-navigation-item__label"><i class="ico ico-youtube">youtube</i></span></a></li>
                        <!--<li class="has-medium-font-size block-navigation-item block-navigation-link"><a class="block-navigation-item__content" href="https://www.tiktok.com/@xxx" title="Nos TikToks, classic burger"><span class="block-navigation-item__label"><i class="ico ico-tiktok">tiktok</i></span></a></li> ça arrive dans la journée hehe -->
                        <!--<li class="has-medium-font-size block-navigation-item block-navigation-link"><a class="block-navigation-item__content" href="https://open.spotify.com/user/xxx" title="Nos bangers musicaux"><span class="block-navigation-item__label"><i class="ico ico-spotify">spotify</i></span></a></li> pas encore la team, ça cook !--> 
                    </ul>
                </nav>
            </div>
