...
<main>
    <article id="main_article" class="main_article page type-page status-publish has-post-thumbnail hentry">
        ...
        <div class="entry-content">
            ...
            <p class="has-text-align-center has-blanc-color has-text-color has-link-color has-medium-font-size" style="margin-top:var(--preset--spacing--50);margin-bottom:var(--preset--spacing--50)"><strong>
                Cher Agent,</strong></p>
            <p class="has-text-align-center has-blanc-color has-text-color has-link-color has-normalup-font-size" style="margin-top:var(--preset--spacing--50);margin-bottom:var(--preset--spacing--50)">
            ...
            <div class="block-buttons is-content-justification-center is-layout-flex">
                <div class="block-button has-custom-font-size is-style-fill has-cooper-hewittheavy-font-family has-normalup-font-size">
                    <a class="block-button__link has-blanc-color has-rouge-background-color has-text-color has-background has-link-color element-button" href="assets/pdf/Carnet défis A&C.pdf" style="border-style:solid; border-radius:6px" target="_blank" rel="noreferrer noopener">CARNET DE MISSIONS A&C</a>
                </div>
            </div>
